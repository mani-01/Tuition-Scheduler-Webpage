...
public class DBConnector {
	...
	// constructor
	public DBConnector() { // need to catch the exception and throw it outside of that method.
		
		try {
			//open the connection as soon as i call the class using this constructor.
			connection = DriverManager.getConnection(URL, USER, PASS);
			
			// create statements as soon as the connection opens (this is basically your INSERT DROP etc...)
